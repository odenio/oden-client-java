...
<a id="bulkDeleteIntervals"></a>
# **bulkDeleteIntervals**
> BulkDeleteIntervals200Response bulkDeleteIntervals(intervalBulkDelete)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      BulkDeleteIntervals200Response result = apiInstance.bulkDeleteIntervals(intervalBulkDelete);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IntervalsApi#bulkDeleteIntervals");
...
<a id="bulkSetIntervals"></a>
# **bulkSetIntervals**
> List&lt;String&gt; bulkSetIntervals(intervalBulkCreate)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<String> result = apiInstance.bulkSetIntervals(intervalBulkCreate);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IntervalsApi#bulkSetIntervals");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="bulkUpdateIntervals"></a>
# **bulkUpdateIntervals**
> BulkUpdateIntervals200Response bulkUpdateIntervals(intervalBulkUpdate)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      BulkUpdateIntervals200Response result = apiInstance.bulkUpdateIntervals(intervalBulkUpdate);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IntervalsApi#bulkUpdateIntervals");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="deleteInterval"></a>
# **deleteInterval**
> List&lt;Interval&gt; deleteInterval(interval)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<Interval> result = apiInstance.deleteInterval(interval);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IntervalsApi#deleteInterval");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="deleteIntervalType"></a>
# **deleteIntervalType**
> IntervalType deleteIntervalType(intervalType)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      IntervalType result = apiInstance.deleteIntervalType(intervalType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IntervalsApi#deleteIntervalType");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="searchIntervalTypes"></a>
# **searchIntervalTypes**
> List&lt;IntervalType&gt; searchIntervalTypes(intervalType)
...
public class Example {
  public static void main(String[] args) {
    ...
    IntervalType intervalType = new IntervalType(); // IntervalType | 
    try {
      List<IntervalType> result = apiInstance.searchIntervalTypes(intervalType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IntervalsApi#searchIntervalTypes");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="searchIntervals"></a>
# **searchIntervals**
> List&lt;Interval&gt; searchIntervals(interval)
...
public class Example {
  public static void main(String[] args) {
    ...
    Interval interval = new Interval(); // Interval | 
    try {
      List<Interval> result = apiInstance.searchIntervals(interval);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IntervalsApi#searchIntervals");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setInterval"></a>
# **setInterval**
> List&lt;Interval&gt; setInterval(interval)
...
public class Example {
  public static void main(String[] args) {
    ...
    Interval interval = new Interval(); // Interval | 
    try {
      List<Interval> result = apiInstance.setInterval(interval);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IntervalsApi#setInterval");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setIntervalType"></a>
# **setIntervalType**
> IntervalType setIntervalType(intervalTypeSet)
...
public class Example {
  public static void main(String[] args) {
    ...
    IntervalsApi apiInstance = new IntervalsApi(defaultClient);
    IntervalTypeSet intervalTypeSet = new IntervalTypeSet(); // IntervalTypeSet | 
    try {
      IntervalType result = apiInstance.setIntervalType(intervalTypeSet);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IntervalsApi#setIntervalType");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | The interval type after set. |  -  |
| **400** | An error occurred regarding one of the input parameters |  -  |
| **401** | User has provided either no credentials or invalid credentials |  -  |
| **403** | User has provided valid credentials but is not authorized to access the entity  |  -  |
| **404** | Entity not found |  -  |
...
# **updateInterval**
> List&lt;Interval&gt; updateInterval(interval)
...
public class Example {
  public static void main(String[] args) {
    ...
    Interval interval = new Interval(); // Interval | 
    try {
      List<Interval> result = apiInstance.updateInterval(interval);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IntervalsApi#updateInterval");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
