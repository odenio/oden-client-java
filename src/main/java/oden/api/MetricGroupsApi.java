...
public class MetricGroupsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public MetricGroupsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public MetricGroupsApi(ApiClient apiClient) {
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 200 </td><td> A list of metric groups. </td><td>  -  </td></tr>
    ...
    public okhttp3.Call v2MetricGroupSearchPostCall(@javax.annotation.Nonnull MetricGroup metricGroup, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = metricGroup;

        // create path and map variables
        String localVarPath = "/v2/metric_group/search";
