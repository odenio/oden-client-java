...
import oden.model.DashboardExecuteRequest;
import oden.model.DashboardExecuteResult;
...
public class DashboardsApi {
    ...
    /**
     * Build call for executeDashboard
     * @param dashboardExecuteRequest  (required)
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 200 </td><td> Dashboard loaded and each module executed. Individual modules may still report &#x60;error&#x60; in their result; this is not a 200/non-200 distinction.  </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call executeDashboardCall(@javax.annotation.Nonnull DashboardExecuteRequest dashboardExecuteRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = dashboardExecuteRequest;

        // create path and map variables
        String localVarPath = "/v2/dashboard/execute";
    ...
    private okhttp3.Call executeDashboardValidateBeforeCall(@javax.annotation.Nonnull DashboardExecuteRequest dashboardExecuteRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'dashboardExecuteRequest' is set
        if (dashboardExecuteRequest == null) {
            throw new ApiException("Missing the required parameter 'dashboardExecuteRequest' when calling executeDashboard(Async)");
        }

        return executeDashboardCall(dashboardExecuteRequest, _callback);
     ...
     * @param dashboardExecuteRequest  (required)
     * @return List&lt;DashboardExecuteResult&gt;
     ...
     */
    public List<DashboardExecuteResult> executeDashboard(@javax.annotation.Nonnull DashboardExecuteRequest dashboardExecuteRequest) throws ApiException {
        ApiResponse<List<DashboardExecuteResult>> localVarResp = executeDashboardWithHttpInfo(dashboardExecuteRequest);
     ...
     * Execute every module in a dashboard with shared time-range and filter overrides, returning the columns and rows produced by each module.  Modules execute in parallel and are reported in the dashboard&#39;s stored module order. Per-module failures (parse, dispatch) land in the &#x60;error&#x60; field of that module&#39;s result; siblings continue to run.  Known v1 limitations: - Template variables (&#x60;{var_name}&#x60; in stored OQL) are not substituted   server-side. Modules containing unsubstituted placeholders will   fail at parse time. 
     * @param dashboardExecuteRequest  (required)
     * @return ApiResponse&lt;List&lt;DashboardExecuteResult&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<List<DashboardExecuteResult>> executeDashboardWithHttpInfo(@javax.annotation.Nonnull DashboardExecuteRequest dashboardExecuteRequest) throws ApiException {
        okhttp3.Call localVarCall = executeDashboardValidateBeforeCall(dashboardExecuteRequest, null);
        Type localVarReturnType = new TypeToken<List<DashboardExecuteResult>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Execute a dashboard (asynchronously)
     * Execute every module in a dashboard with shared time-range and filter overrides, returning the columns and rows produced by each module.  Modules execute in parallel and are reported in the dashboard&#39;s stored module order. Per-module failures (parse, dispatch) land in the &#x60;error&#x60; field of that module&#39;s result; siblings continue to run.  Known v1 limitations: - Template variables (&#x60;{var_name}&#x60; in stored OQL) are not substituted   server-side. Modules containing unsubstituted placeholders will   fail at parse time. 
     * @param dashboardExecuteRequest  (required)
     ...
     */
    public okhttp3.Call executeDashboardAsync(@javax.annotation.Nonnull DashboardExecuteRequest dashboardExecuteRequest, final ApiCallback<List<DashboardExecuteResult>> _callback) throws ApiException {

        okhttp3.Call localVarCall = executeDashboardValidateBeforeCall(dashboardExecuteRequest, _callback);
        Type localVarReturnType = new TypeToken<List<DashboardExecuteResult>>(){}.getType();
