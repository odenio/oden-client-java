...
public class DashboardColumnSpec {
  ...
  public DashboardColumnSpec() {
  }

  public DashboardColumnSpec name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public DashboardColumnSpec type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DashboardColumnSpec dashboardColumnSpec = (DashboardColumnSpec) o;
    return Objects.equals(this.name, dashboardColumnSpec.name) &&
        Objects.equals(this.type, dashboardColumnSpec.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class DashboardColumnSpec {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DashboardColumnSpec
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DashboardColumnSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DashboardColumnSpec is not found in the empty JSON string", DashboardColumnSpec.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DashboardColumnSpec.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DashboardColumnSpec` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DashboardColumnSpec.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DashboardColumnSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DashboardColumnSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DashboardColumnSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DashboardColumnSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<DashboardColumnSpec>() {
           @Override
           public void write(JsonWriter out, DashboardColumnSpec value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DashboardColumnSpec read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DashboardColumnSpec given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DashboardColumnSpec
   * @throws IOException if the JSON string is invalid with respect to DashboardColumnSpec
   */
  public static DashboardColumnSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DashboardColumnSpec.class);
  }

  /**
   * Convert an instance of DashboardColumnSpec to an JSON string
   *
   * @return JSON string
   */
