...
import oden.model.DashboardExecuteFilters;
import oden.model.DashboardExecuteRange;
import oden.model.DashboardExecuteRequestDashboard;
...
public class DashboardExecuteRequest {
  public static final String SERIALIZED_NAME_DASHBOARD = "dashboard";
  @SerializedName(SERIALIZED_NAME_DASHBOARD)
  @javax.annotation.Nonnull
  private DashboardExecuteRequestDashboard dashboard;

  public static final String SERIALIZED_NAME_RANGE = "range";
  @SerializedName(SERIALIZED_NAME_RANGE)
  @javax.annotation.Nullable
  private DashboardExecuteRange range;

  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  @javax.annotation.Nullable
  private DashboardExecuteFilters filters;

  public DashboardExecuteRequest() {
  }

  public DashboardExecuteRequest dashboard(@javax.annotation.Nonnull DashboardExecuteRequestDashboard dashboard) {
   ...
   */
  @javax.annotation.Nonnull
  public DashboardExecuteRequestDashboard getDashboard() {
    return dashboard;
  }

  public void setDashboard(@javax.annotation.Nonnull DashboardExecuteRequestDashboard dashboard) {
    this.dashboard = dashboard;
  }


  public DashboardExecuteRequest range(@javax.annotation.Nullable DashboardExecuteRange range) {
    this.range = range;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public DashboardExecuteRange getRange() {
    return range;
  }

  public void setRange(@javax.annotation.Nullable DashboardExecuteRange range) {
    this.range = range;
  }


  public DashboardExecuteRequest filters(@javax.annotation.Nullable DashboardExecuteFilters filters) {
   ...
   */
  @javax.annotation.Nullable
  public DashboardExecuteFilters getFilters() {
    return filters;
  }

  public void setFilters(@javax.annotation.Nullable DashboardExecuteFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    DashboardExecuteRequest dashboardExecuteRequest = (DashboardExecuteRequest) o;
    return Objects.equals(this.dashboard, dashboardExecuteRequest.dashboard) &&
        Objects.equals(this.range, dashboardExecuteRequest.range) &&
        Objects.equals(this.filters, dashboardExecuteRequest.filters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dashboard, range, filters);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DashboardExecuteRequest {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("dashboard", "range", "filters"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("dashboard"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DashboardExecuteRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DashboardExecuteRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DashboardExecuteRequest is not found in the empty JSON string", DashboardExecuteRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DashboardExecuteRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DashboardExecuteRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DashboardExecuteRequest.openapiRequiredFields) {
      ...
      DashboardExecuteRequestDashboard.validateJsonElement(jsonObj.get("dashboard"));
      // validate the optional field `range`
      if (jsonObj.get("range") != null && !jsonObj.get("range").isJsonNull()) {
        DashboardExecuteRange.validateJsonElement(jsonObj.get("range"));
      }
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        DashboardExecuteFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DashboardExecuteRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DashboardExecuteRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DashboardExecuteRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DashboardExecuteRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DashboardExecuteRequest>() {
           @Override
           public void write(JsonWriter out, DashboardExecuteRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DashboardExecuteRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DashboardExecuteRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DashboardExecuteRequest
   * @throws IOException if the JSON string is invalid with respect to DashboardExecuteRequest
   */
  public static DashboardExecuteRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DashboardExecuteRequest.class);
  }

  /**
   * Convert an instance of DashboardExecuteRequest to an JSON string
   *
   * @return JSON string
   */
