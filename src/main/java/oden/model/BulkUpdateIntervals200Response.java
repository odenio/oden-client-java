...
import oden.model.BulkUpdateIntervals200ResponseFailedIntervalsInner;
...
public class BulkUpdateIntervals200Response {
  ...
  @javax.annotation.Nullable
  private List<BulkUpdateIntervals200ResponseFailedIntervalsInner> failedIntervals = new ArrayList<>();

  public BulkUpdateIntervals200Response() {
  }

  public BulkUpdateIntervals200Response numUpdated(@javax.annotation.Nullable Integer numUpdated) {
  ...
  public BulkUpdateIntervals200Response updatedIntervals(@javax.annotation.Nullable List<Interval> updatedIntervals) {
    this.updatedIntervals = updatedIntervals;
    return this;
  }

  public BulkUpdateIntervals200Response addUpdatedIntervalsItem(Interval updatedIntervalsItem) {
  ...
  public BulkUpdateIntervals200Response numFailed(@javax.annotation.Nullable Integer numFailed) {
  ...
  public BulkUpdateIntervals200Response failedIntervals(@javax.annotation.Nullable List<BulkUpdateIntervals200ResponseFailedIntervalsInner> failedIntervals) {
    this.failedIntervals = failedIntervals;
    return this;
  }

  public BulkUpdateIntervals200Response addFailedIntervalsItem(BulkUpdateIntervals200ResponseFailedIntervalsInner failedIntervalsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<BulkUpdateIntervals200ResponseFailedIntervalsInner> getFailedIntervals() {
    return failedIntervals;
  }

  public void setFailedIntervals(@javax.annotation.Nullable List<BulkUpdateIntervals200ResponseFailedIntervalsInner> failedIntervals) {
    this.failedIntervals = failedIntervals;
  }
  ...
  public boolean equals(Object o) {
    ...
    BulkUpdateIntervals200Response bulkUpdateIntervals200Response = (BulkUpdateIntervals200Response) o;
    return Objects.equals(this.numUpdated, bulkUpdateIntervals200Response.numUpdated) &&
        Objects.equals(this.updatedIntervals, bulkUpdateIntervals200Response.updatedIntervals) &&
        Objects.equals(this.numFailed, bulkUpdateIntervals200Response.numFailed) &&
        Objects.equals(this.failedIntervals, bulkUpdateIntervals200Response.failedIntervals);
  }
  ...
  public String toString() {
    ...
    sb.append("class BulkUpdateIntervals200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BulkUpdateIntervals200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BulkUpdateIntervals200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BulkUpdateIntervals200Response is not found in the empty JSON string", BulkUpdateIntervals200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BulkUpdateIntervals200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BulkUpdateIntervals200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("failed_intervals") != null && !jsonObj.get("failed_intervals").isJsonNull()) {
        ...
        if (jsonArrayfailedIntervals != null) {
          ...
          for (int i = 0; i < jsonArrayfailedIntervals.size(); i++) {
            BulkUpdateIntervals200ResponseFailedIntervalsInner.validateJsonElement(jsonArrayfailedIntervals.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BulkUpdateIntervals200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BulkUpdateIntervals200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BulkUpdateIntervals200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BulkUpdateIntervals200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<BulkUpdateIntervals200Response>() {
           @Override
           public void write(JsonWriter out, BulkUpdateIntervals200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BulkUpdateIntervals200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BulkUpdateIntervals200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BulkUpdateIntervals200Response
   * @throws IOException if the JSON string is invalid with respect to BulkUpdateIntervals200Response
   */
  public static BulkUpdateIntervals200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BulkUpdateIntervals200Response.class);
  }

  /**
   * Convert an instance of BulkUpdateIntervals200Response to an JSON string
   *
   * @return JSON string
   */
