...
public class DashboardExecuteFiltersCustomIntervalsInner {
  ...
  public DashboardExecuteFiltersCustomIntervalsInner() {
  }

  public DashboardExecuteFiltersCustomIntervalsInner type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public DashboardExecuteFiltersCustomIntervalsInner valueContains(@javax.annotation.Nonnull String valueContains) {
  ...
  public void setValueContains(@javax.annotation.Nonnull String valueContains) {
    this.valueContains = valueContains;
  }
  ...
  public boolean equals(Object o) {
    ...
    DashboardExecuteFiltersCustomIntervalsInner dashboardExecuteFiltersCustomIntervalsInner = (DashboardExecuteFiltersCustomIntervalsInner) o;
    return Objects.equals(this.type, dashboardExecuteFiltersCustomIntervalsInner.type) &&
        Objects.equals(this.valueContains, dashboardExecuteFiltersCustomIntervalsInner.valueContains);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, valueContains);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DashboardExecuteFiltersCustomIntervalsInner {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "value_contains"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("type", "value_contains"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DashboardExecuteFiltersCustomIntervalsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DashboardExecuteFiltersCustomIntervalsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DashboardExecuteFiltersCustomIntervalsInner is not found in the empty JSON string", DashboardExecuteFiltersCustomIntervalsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DashboardExecuteFiltersCustomIntervalsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DashboardExecuteFiltersCustomIntervalsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DashboardExecuteFiltersCustomIntervalsInner.openapiRequiredFields) {
      ...
      if (!jsonObj.get("value_contains").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `value_contains` to be a primitive type in the JSON string but got `%s`", jsonObj.get("value_contains").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DashboardExecuteFiltersCustomIntervalsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DashboardExecuteFiltersCustomIntervalsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DashboardExecuteFiltersCustomIntervalsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DashboardExecuteFiltersCustomIntervalsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<DashboardExecuteFiltersCustomIntervalsInner>() {
           @Override
           public void write(JsonWriter out, DashboardExecuteFiltersCustomIntervalsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DashboardExecuteFiltersCustomIntervalsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DashboardExecuteFiltersCustomIntervalsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DashboardExecuteFiltersCustomIntervalsInner
   * @throws IOException if the JSON string is invalid with respect to DashboardExecuteFiltersCustomIntervalsInner
   */
  public static DashboardExecuteFiltersCustomIntervalsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DashboardExecuteFiltersCustomIntervalsInner.class);
  }

  /**
   * Convert an instance of DashboardExecuteFiltersCustomIntervalsInner to an JSON string
   *
   * @return JSON string
   */
