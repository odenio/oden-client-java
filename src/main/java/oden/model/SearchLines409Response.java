...
public class SearchLines409Response {
  ...
  public SearchLines409Response() {
  }

  public SearchLines409Response entityName(@javax.annotation.Nonnull String entityName) {
  ...
  public SearchLines409Response numMatches(@javax.annotation.Nonnull Integer numMatches) {
  ...
  public SearchLines409Response error(@javax.annotation.Nonnull String error) {
    this.error = error;
    return this;
  }
  ...
  public SearchLines409Response retryable(@javax.annotation.Nonnull Boolean retryable) {
  ...
  public boolean equals(Object o) {
    ...
    SearchLines409Response searchLines409Response = (SearchLines409Response) o;
    return Objects.equals(this.entityName, searchLines409Response.entityName) &&
        Objects.equals(this.numMatches, searchLines409Response.numMatches) &&
        Objects.equals(this.error, searchLines409Response.error) &&
        Objects.equals(this.retryable, searchLines409Response.retryable);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchLines409Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchLines409Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchLines409Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SearchLines409Response is not found in the empty JSON string", SearchLines409Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchLines409Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SearchLines409Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SearchLines409Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchLines409Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchLines409Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchLines409Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchLines409Response.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchLines409Response>() {
           @Override
           public void write(JsonWriter out, SearchLines409Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchLines409Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchLines409Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchLines409Response
   * @throws IOException if the JSON string is invalid with respect to SearchLines409Response
   */
  public static SearchLines409Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchLines409Response.class);
  }

  /**
   * Convert an instance of SearchLines409Response to an JSON string
   *
   * @return JSON string
   */
