...
public class IntervalTypeSet {
  ...
  public static final String SERIALIZED_NAME_METADATA_SCHEMA = "metadata_schema";
  @SerializedName(SERIALIZED_NAME_METADATA_SCHEMA)
  @javax.annotation.Nullable
  ...
  public IntervalTypeSet() {
  }

  public IntervalTypeSet id(@javax.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public IntervalTypeSet name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public IntervalTypeSet metadataSchema(@javax.annotation.Nullable String metadataSchema) {
  ...
  public void setMetadataSchema(@javax.annotation.Nullable String metadataSchema) {
    this.metadataSchema = metadataSchema;
  }


  public IntervalTypeSet tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public IntervalTypeSet addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    IntervalTypeSet intervalTypeSet = (IntervalTypeSet) o;
    return Objects.equals(this.id, intervalTypeSet.id) &&
        Objects.equals(this.name, intervalTypeSet.name) &&
        Objects.equals(this.metadataSchema, intervalTypeSet.metadataSchema) &&
        Objects.equals(this.tags, intervalTypeSet.tags);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, metadataSchema, tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class IntervalTypeSet {\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    metadataSchema: ").append(toIndentedString(metadataSchema)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "name", "metadata_schema", "tags"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to IntervalTypeSet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntervalTypeSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IntervalTypeSet is not found in the empty JSON string", IntervalTypeSet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IntervalTypeSet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `IntervalTypeSet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("metadata_schema") != null && !jsonObj.get("metadata_schema").isJsonNull()) && !jsonObj.get("metadata_schema").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `metadata_schema` to be a primitive type in the JSON string but got `%s`", jsonObj.get("metadata_schema").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IntervalTypeSet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IntervalTypeSet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IntervalTypeSet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IntervalTypeSet.class));

       return (TypeAdapter<T>) new TypeAdapter<IntervalTypeSet>() {
           @Override
           public void write(JsonWriter out, IntervalTypeSet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IntervalTypeSet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IntervalTypeSet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IntervalTypeSet
   * @throws IOException if the JSON string is invalid with respect to IntervalTypeSet
   */
  public static IntervalTypeSet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IntervalTypeSet.class);
  }

  /**
   * Convert an instance of IntervalTypeSet to an JSON string
   *
   * @return JSON string
   */
