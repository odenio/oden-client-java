...
public class Unit {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("kind_of_quantity") != null && !jsonObj.get("kind_of_quantity").isJsonNull()) && !jsonObj.get("kind_of_quantity").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `kind_of_quantity` to be a primitive type in the JSON string but got `%s`", jsonObj.get("kind_of_quantity").toString()));
      }
  }
