...
public class Unit {
  ...
  public static final String SERIALIZED_NAME_KIND_OF_QUANTITY = "kind_of_quantity";
  @SerializedName(SERIALIZED_NAME_KIND_OF_QUANTITY)
  @javax.annotation.Nullable
  private String kindOfQuantity;

  public Unit() {
  }

  public Unit id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Unit symbol(@javax.annotation.Nullable String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public Unit name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public Unit kindOfQuantity(@javax.annotation.Nullable String kindOfQuantity) {
   ...
   */
  @javax.annotation.Nullable
  public String getKindOfQuantity() {
    return kindOfQuantity;
  }

  public void setKindOfQuantity(@javax.annotation.Nullable String kindOfQuantity) {
    this.kindOfQuantity = kindOfQuantity;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, unit.id) &&
        ...
        Objects.equals(this.kindOfQuantity, unit.kindOfQuantity);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, symbol, name, kindOfQuantity);
  }
  ...
  public String toString() {
    ...
    sb.append("    kindOfQuantity: ").append(toIndentedString(kindOfQuantity)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "symbol", "name", "kind_of_quantity"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Unit.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Unit is not found in the empty JSON string", Unit.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Unit.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Unit` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("kind_of_quantity") != null && !jsonObj.get("kind_of_quantity").isJsonNull()) && !jsonObj.get("kind_of_quantity").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `kind_of_quantity` to be a primitive type in the JSON string but got `%s`", jsonObj.get("kind_of_quantity").toString()));
      }
  }
