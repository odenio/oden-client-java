...
public class StateCategory {
  ...
  public StateCategory id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public StateCategory name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StateCategory stateCategory = (StateCategory) o;
    return Objects.equals(this.id, stateCategory.id) &&
        Objects.equals(this.name, stateCategory.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StateCategory
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StateCategory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StateCategory is not found in the empty JSON string", StateCategory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StateCategory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `StateCategory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StateCategory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StateCategory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StateCategory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StateCategory.class));

       return (TypeAdapter<T>) new TypeAdapter<StateCategory>() {
           @Override
           public void write(JsonWriter out, StateCategory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StateCategory read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StateCategory given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StateCategory
   * @throws IOException if the JSON string is invalid with respect to StateCategory
   */
  public static StateCategory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StateCategory.class);
  }

  /**
   * Convert an instance of StateCategory to an JSON string
   *
   * @return JSON string
   */
