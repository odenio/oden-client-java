...
import oden.model.DashboardExecuteFiltersStatesStateCategoryAndReasonsInner;
...
public class DashboardExecuteFiltersStates {
  public static final String SERIALIZED_NAME_STATE_TYPES = "state_types";
  @SerializedName(SERIALIZED_NAME_STATE_TYPES)
  @javax.annotation.Nullable
  private List<String> stateTypes = new ArrayList<>();

  public static final String SERIALIZED_NAME_STATE_CATEGORY_AND_REASONS = "state_category_and_reasons";
  @SerializedName(SERIALIZED_NAME_STATE_CATEGORY_AND_REASONS)
  @javax.annotation.Nullable
  private List<DashboardExecuteFiltersStatesStateCategoryAndReasonsInner> stateCategoryAndReasons = new ArrayList<>();

  public DashboardExecuteFiltersStates() {
  }

  public DashboardExecuteFiltersStates stateTypes(@javax.annotation.Nullable List<String> stateTypes) {
    this.stateTypes = stateTypes;
    return this;
  }

  public DashboardExecuteFiltersStates addStateTypesItem(String stateTypesItem) {
    if (this.stateTypes == null) {
      this.stateTypes = new ArrayList<>();
    }
    this.stateTypes.add(stateTypesItem);
    return this;
  }
  ...
  public void setStateTypes(@javax.annotation.Nullable List<String> stateTypes) {
    this.stateTypes = stateTypes;
  }


  public DashboardExecuteFiltersStates stateCategoryAndReasons(@javax.annotation.Nullable List<DashboardExecuteFiltersStatesStateCategoryAndReasonsInner> stateCategoryAndReasons) {
    this.stateCategoryAndReasons = stateCategoryAndReasons;
    return this;
  }

  public DashboardExecuteFiltersStates addStateCategoryAndReasonsItem(DashboardExecuteFiltersStatesStateCategoryAndReasonsInner stateCategoryAndReasonsItem) {
    if (this.stateCategoryAndReasons == null) {
      this.stateCategoryAndReasons = new ArrayList<>();
    }
    this.stateCategoryAndReasons.add(stateCategoryAndReasonsItem);
    return this;
  }

  /**
   * Get stateCategoryAndReasons
   * @return stateCategoryAndReasons
   */
  @javax.annotation.Nullable
  public List<DashboardExecuteFiltersStatesStateCategoryAndReasonsInner> getStateCategoryAndReasons() {
    return stateCategoryAndReasons;
  }

  public void setStateCategoryAndReasons(@javax.annotation.Nullable List<DashboardExecuteFiltersStatesStateCategoryAndReasonsInner> stateCategoryAndReasons) {
    this.stateCategoryAndReasons = stateCategoryAndReasons;
  }
  ...
  public boolean equals(Object o) {
    ...
    DashboardExecuteFiltersStates dashboardExecuteFiltersStates = (DashboardExecuteFiltersStates) o;
    return Objects.equals(this.stateTypes, dashboardExecuteFiltersStates.stateTypes) &&
        Objects.equals(this.stateCategoryAndReasons, dashboardExecuteFiltersStates.stateCategoryAndReasons);
  }

  @Override
  public int hashCode() {
    return Objects.hash(stateTypes, stateCategoryAndReasons);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DashboardExecuteFiltersStates {\n");
    sb.append("    stateTypes: ").append(toIndentedString(stateTypes)).append("\n");
    sb.append("    stateCategoryAndReasons: ").append(toIndentedString(stateCategoryAndReasons)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("state_types", "state_category_and_reasons"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to DashboardExecuteFiltersStates
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DashboardExecuteFiltersStates.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DashboardExecuteFiltersStates is not found in the empty JSON string", DashboardExecuteFiltersStates.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DashboardExecuteFiltersStates.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DashboardExecuteFiltersStates` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("state_types") != null && !jsonObj.get("state_types").isJsonNull() && !jsonObj.get("state_types").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `state_types` to be an array in the JSON string but got `%s`", jsonObj.get("state_types").toString()));
      }
      if (jsonObj.get("state_category_and_reasons") != null && !jsonObj.get("state_category_and_reasons").isJsonNull()) {
        JsonArray jsonArraystateCategoryAndReasons = jsonObj.getAsJsonArray("state_category_and_reasons");
        if (jsonArraystateCategoryAndReasons != null) {
          // ensure the json data is an array
          if (!jsonObj.get("state_category_and_reasons").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `state_category_and_reasons` to be an array in the JSON string but got `%s`", jsonObj.get("state_category_and_reasons").toString()));
          }

          // validate the optional field `state_category_and_reasons` (array)
          for (int i = 0; i < jsonArraystateCategoryAndReasons.size(); i++) {
            DashboardExecuteFiltersStatesStateCategoryAndReasonsInner.validateJsonElement(jsonArraystateCategoryAndReasons.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DashboardExecuteFiltersStates.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DashboardExecuteFiltersStates' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DashboardExecuteFiltersStates> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DashboardExecuteFiltersStates.class));

       return (TypeAdapter<T>) new TypeAdapter<DashboardExecuteFiltersStates>() {
           @Override
           public void write(JsonWriter out, DashboardExecuteFiltersStates value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DashboardExecuteFiltersStates read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DashboardExecuteFiltersStates given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DashboardExecuteFiltersStates
   * @throws IOException if the JSON string is invalid with respect to DashboardExecuteFiltersStates
   */
  public static DashboardExecuteFiltersStates fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DashboardExecuteFiltersStates.class);
  }

  /**
   * Convert an instance of DashboardExecuteFiltersStates to an JSON string
   *
   * @return JSON string
   */
