...
public class V2IntervalsDeletePost200Response {
  ...
  @javax.annotation.Nullable
  private List<String> failedIntervals = new ArrayList<>();

  public V2IntervalsDeletePost200Response() {
  }

  public V2IntervalsDeletePost200Response numDeleted(@javax.annotation.Nullable Integer numDeleted) {
  ...
  public V2IntervalsDeletePost200Response failedIntervals(@javax.annotation.Nullable List<String> failedIntervals) {
    this.failedIntervals = failedIntervals;
    return this;
  }

  public V2IntervalsDeletePost200Response addFailedIntervalsItem(String failedIntervalsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<String> getFailedIntervals() {
    return failedIntervals;
  }

  public void setFailedIntervals(@javax.annotation.Nullable List<String> failedIntervals) {
    this.failedIntervals = failedIntervals;
  }
  ...
  public boolean equals(Object o) {
    ...
    V2IntervalsDeletePost200Response v2IntervalsDeletePost200Response = (V2IntervalsDeletePost200Response) o;
    return Objects.equals(this.numDeleted, v2IntervalsDeletePost200Response.numDeleted) &&
        Objects.equals(this.failedIntervals, v2IntervalsDeletePost200Response.failedIntervals);
  }

  @Override
  public int hashCode() {
    return Objects.hash(numDeleted, failedIntervals);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V2IntervalsDeletePost200Response {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("num_deleted", "failed_intervals"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to V2IntervalsDeletePost200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V2IntervalsDeletePost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V2IntervalsDeletePost200Response is not found in the empty JSON string", V2IntervalsDeletePost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V2IntervalsDeletePost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V2IntervalsDeletePost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("failed_intervals") != null && !jsonObj.get("failed_intervals").isJsonNull() && !jsonObj.get("failed_intervals").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V2IntervalsDeletePost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V2IntervalsDeletePost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V2IntervalsDeletePost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V2IntervalsDeletePost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<V2IntervalsDeletePost200Response>() {
           @Override
           public void write(JsonWriter out, V2IntervalsDeletePost200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V2IntervalsDeletePost200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V2IntervalsDeletePost200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V2IntervalsDeletePost200Response
   * @throws IOException if the JSON string is invalid with respect to V2IntervalsDeletePost200Response
   */
  public static V2IntervalsDeletePost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V2IntervalsDeletePost200Response.class);
  }

  /**
   * Convert an instance of V2IntervalsDeletePost200Response to an JSON string
   *
   * @return JSON string
   */
