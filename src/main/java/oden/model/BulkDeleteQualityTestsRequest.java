...
public class BulkDeleteQualityTestsRequest {
  ...
  public BulkDeleteQualityTestsRequest() {
  }

  public BulkDeleteQualityTestsRequest ids(@javax.annotation.Nullable List<UUID> ids) {
    this.ids = ids;
    return this;
  }

  public BulkDeleteQualityTestsRequest addIdsItem(UUID idsItem) {
    if (this.ids == null) {
  ...
  public BulkDeleteQualityTestsRequest line(@javax.annotation.Nullable Line line) {
    this.line = line;
    return this;
  }
  ...
  public BulkDeleteQualityTestsRequest startTime(@javax.annotation.Nullable OffsetDateTime startTime) {
  ...
  public BulkDeleteQualityTestsRequest endTime(@javax.annotation.Nullable OffsetDateTime endTime) {
  ...
  public boolean equals(Object o) {
    ...
    BulkDeleteQualityTestsRequest bulkDeleteQualityTestsRequest = (BulkDeleteQualityTestsRequest) o;
    return Objects.equals(this.ids, bulkDeleteQualityTestsRequest.ids) &&
        Objects.equals(this.line, bulkDeleteQualityTestsRequest.line) &&
        Objects.equals(this.startTime, bulkDeleteQualityTestsRequest.startTime) &&
        Objects.equals(this.endTime, bulkDeleteQualityTestsRequest.endTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class BulkDeleteQualityTestsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BulkDeleteQualityTestsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BulkDeleteQualityTestsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BulkDeleteQualityTestsRequest is not found in the empty JSON string", BulkDeleteQualityTestsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BulkDeleteQualityTestsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BulkDeleteQualityTestsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BulkDeleteQualityTestsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BulkDeleteQualityTestsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BulkDeleteQualityTestsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BulkDeleteQualityTestsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<BulkDeleteQualityTestsRequest>() {
           @Override
           public void write(JsonWriter out, BulkDeleteQualityTestsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BulkDeleteQualityTestsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BulkDeleteQualityTestsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BulkDeleteQualityTestsRequest
   * @throws IOException if the JSON string is invalid with respect to BulkDeleteQualityTestsRequest
   */
  public static BulkDeleteQualityTestsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BulkDeleteQualityTestsRequest.class);
  }

  /**
   * Convert an instance of BulkDeleteQualityTestsRequest to an JSON string
   *
   * @return JSON string
   */
