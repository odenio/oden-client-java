...
public class IntervalBulkCreate {
  ...
  public IntervalBulkCreate() {
  }

  public IntervalBulkCreate type(@javax.annotation.Nullable IntervalType type) {
    this.type = type;
    return this;
  }
  ...
  public IntervalBulkCreate line(@javax.annotation.Nullable Line line) {
    this.line = line;
    return this;
  }
  ...
  public IntervalBulkCreate intervals(@javax.annotation.Nullable List<Interval> intervals) {
    this.intervals = intervals;
    return this;
  }

  public IntervalBulkCreate addIntervalsItem(Interval intervalsItem) {
  ...
  public boolean equals(Object o) {
    ...
    IntervalBulkCreate intervalBulkCreate = (IntervalBulkCreate) o;
    return Objects.equals(this.type, intervalBulkCreate.type) &&
        Objects.equals(this.line, intervalBulkCreate.line) &&
        Objects.equals(this.intervals, intervalBulkCreate.intervals);
  }
  ...
  public String toString() {
    ...
    sb.append("class IntervalBulkCreate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IntervalBulkCreate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntervalBulkCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IntervalBulkCreate is not found in the empty JSON string", IntervalBulkCreate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IntervalBulkCreate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `IntervalBulkCreate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IntervalBulkCreate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IntervalBulkCreate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IntervalBulkCreate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IntervalBulkCreate.class));

       return (TypeAdapter<T>) new TypeAdapter<IntervalBulkCreate>() {
           @Override
           public void write(JsonWriter out, IntervalBulkCreate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IntervalBulkCreate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IntervalBulkCreate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IntervalBulkCreate
   * @throws IOException if the JSON string is invalid with respect to IntervalBulkCreate
   */
  public static IntervalBulkCreate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IntervalBulkCreate.class);
  }

  /**
   * Convert an instance of IntervalBulkCreate to an JSON string
   *
   * @return JSON string
   */
