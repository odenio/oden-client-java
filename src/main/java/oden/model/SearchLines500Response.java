...
public class SearchLines500Response {
  ...
  public SearchLines500Response() {
  }

  public SearchLines500Response error(@javax.annotation.Nonnull String error) {
    this.error = error;
    return this;
  }
  ...
  public SearchLines500Response retryable(@javax.annotation.Nonnull Boolean retryable) {
  ...
  public SearchLines500Response id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SearchLines500Response searchLines500Response = (SearchLines500Response) o;
    return Objects.equals(this.error, searchLines500Response.error) &&
        Objects.equals(this.retryable, searchLines500Response.retryable) &&
        Objects.equals(this.id, searchLines500Response.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchLines500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchLines500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchLines500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SearchLines500Response is not found in the empty JSON string", SearchLines500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchLines500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SearchLines500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SearchLines500Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchLines500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchLines500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchLines500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchLines500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchLines500Response>() {
           @Override
           public void write(JsonWriter out, SearchLines500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchLines500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchLines500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchLines500Response
   * @throws IOException if the JSON string is invalid with respect to SearchLines500Response
   */
  public static SearchLines500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchLines500Response.class);
  }

  /**
   * Convert an instance of SearchLines500Response to an JSON string
   *
   * @return JSON string
   */
