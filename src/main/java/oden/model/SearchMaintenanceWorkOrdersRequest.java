...
public class SearchMaintenanceWorkOrdersRequest {
  ...
  public SearchMaintenanceWorkOrdersRequest() {
  }

  public SearchMaintenanceWorkOrdersRequest id(@javax.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public SearchMaintenanceWorkOrdersRequest externalId(@javax.annotation.Nullable String externalId) {
  ...
  public SearchMaintenanceWorkOrdersRequest line(@javax.annotation.Nullable Line line) {
    this.line = line;
    return this;
  }
  ...
  public SearchMaintenanceWorkOrdersRequest startTime(@javax.annotation.Nullable OffsetDateTime startTime) {
  ...
  public SearchMaintenanceWorkOrdersRequest endTime(@javax.annotation.Nullable OffsetDateTime endTime) {
  ...
  public SearchMaintenanceWorkOrdersRequest match(@javax.annotation.Nullable Match match) {
    this.match = match;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SearchMaintenanceWorkOrdersRequest searchMaintenanceWorkOrdersRequest = (SearchMaintenanceWorkOrdersRequest) o;
    return Objects.equals(this.id, searchMaintenanceWorkOrdersRequest.id) &&
        Objects.equals(this.externalId, searchMaintenanceWorkOrdersRequest.externalId) &&
        Objects.equals(this.line, searchMaintenanceWorkOrdersRequest.line) &&
        Objects.equals(this.startTime, searchMaintenanceWorkOrdersRequest.startTime) &&
        Objects.equals(this.endTime, searchMaintenanceWorkOrdersRequest.endTime) &&
        Objects.equals(this.match, searchMaintenanceWorkOrdersRequest.match);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchMaintenanceWorkOrdersRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchMaintenanceWorkOrdersRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchMaintenanceWorkOrdersRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SearchMaintenanceWorkOrdersRequest is not found in the empty JSON string", SearchMaintenanceWorkOrdersRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchMaintenanceWorkOrdersRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SearchMaintenanceWorkOrdersRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchMaintenanceWorkOrdersRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchMaintenanceWorkOrdersRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchMaintenanceWorkOrdersRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchMaintenanceWorkOrdersRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchMaintenanceWorkOrdersRequest>() {
           @Override
           public void write(JsonWriter out, SearchMaintenanceWorkOrdersRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchMaintenanceWorkOrdersRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchMaintenanceWorkOrdersRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchMaintenanceWorkOrdersRequest
   * @throws IOException if the JSON string is invalid with respect to SearchMaintenanceWorkOrdersRequest
   */
  public static SearchMaintenanceWorkOrdersRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchMaintenanceWorkOrdersRequest.class);
  }

  /**
   * Convert an instance of SearchMaintenanceWorkOrdersRequest to an JSON string
   *
   * @return JSON string
   */
