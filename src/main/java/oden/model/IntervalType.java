...
public class IntervalType {
  ...
  public IntervalType id(@javax.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public IntervalType factory(@javax.annotation.Nullable Factory factory) {
  ...
  public IntervalType name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public IntervalType match(@javax.annotation.Nullable Match match) {
    this.match = match;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    IntervalType intervalType = (IntervalType) o;
    return Objects.equals(this.id, intervalType.id) &&
        Objects.equals(this.factory, intervalType.factory) &&
        Objects.equals(this.name, intervalType.name) &&
        Objects.equals(this.match, intervalType.match);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, factory, name, match);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IntervalType {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "factory", "name", "match"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to IntervalType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntervalType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IntervalType is not found in the empty JSON string", IntervalType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IntervalType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IntervalType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IntervalType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IntervalType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IntervalType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IntervalType.class));

       return (TypeAdapter<T>) new TypeAdapter<IntervalType>() {
           @Override
           public void write(JsonWriter out, IntervalType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IntervalType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IntervalType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IntervalType
   * @throws IOException if the JSON string is invalid with respect to IntervalType
   */
  public static IntervalType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IntervalType.class);
  }

  /**
   * Convert an instance of IntervalType to an JSON string
   *
   * @return JSON string
   */
