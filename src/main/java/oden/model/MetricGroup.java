...
public class MetricGroup {
  ...
  public static final String SERIALIZED_NAME_UNIT_KIND_OF_QUANTITY = "unit_kind_of_quantity";
  @SerializedName(SERIALIZED_NAME_UNIT_KIND_OF_QUANTITY)
  @javax.annotation.Nullable
  private String unitKindOfQuantity;
  ...
  public MetricGroup name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public MetricGroup description(@javax.annotation.Nullable String description) {
  ...
  public MetricGroup id(@javax.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public MetricGroup unitKindOfQuantity(@javax.annotation.Nullable String unitKindOfQuantity) {
    this.unitKindOfQuantity = unitKindOfQuantity;
    return this;
  }

  /**
   * Get unitKindOfQuantity
   * @return unitKindOfQuantity
   */
  @javax.annotation.Nullable
  public String getUnitKindOfQuantity() {
    return unitKindOfQuantity;
  }

  public void setUnitKindOfQuantity(@javax.annotation.Nullable String unitKindOfQuantity) {
    this.unitKindOfQuantity = unitKindOfQuantity;
  }


  public MetricGroup match(@javax.annotation.Nullable Match match) {
    this.match = match;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, metricGroup.name) &&
        Objects.equals(this.description, metricGroup.description) &&
        Objects.equals(this.id, metricGroup.id) &&
        Objects.equals(this.unitKindOfQuantity, metricGroup.unitKindOfQuantity) &&
        Objects.equals(this.match, metricGroup.match);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, id, unitKindOfQuantity, match);
  }
  ...
  public String toString() {
    ...
    sb.append("    unitKindOfQuantity: ").append(toIndentedString(unitKindOfQuantity)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "description", "id", "unit_kind_of_quantity", "match"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetricGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MetricGroup is not found in the empty JSON string", MetricGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MetricGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MetricGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("unit_kind_of_quantity") != null && !jsonObj.get("unit_kind_of_quantity").isJsonNull()) && !jsonObj.get("unit_kind_of_quantity").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `unit_kind_of_quantity` to be a primitive type in the JSON string but got `%s`", jsonObj.get("unit_kind_of_quantity").toString()));
      }
