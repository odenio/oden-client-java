...
public class MetricGroup {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("unit_kind_of_quantity") != null && !jsonObj.get("unit_kind_of_quantity").isJsonNull()) && !jsonObj.get("unit_kind_of_quantity").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `unit_kind_of_quantity` to be a primitive type in the JSON string but got `%s`", jsonObj.get("unit_kind_of_quantity").toString()));
      }
