...
public class DashboardExecuteFiltersLinesInner {
  ...
  public DashboardExecuteFiltersLinesInner() {
  }

  public DashboardExecuteFiltersLinesInner id(@javax.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public DashboardExecuteFiltersLinesInner name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DashboardExecuteFiltersLinesInner dashboardExecuteFiltersLinesInner = (DashboardExecuteFiltersLinesInner) o;
    return Objects.equals(this.id, dashboardExecuteFiltersLinesInner.id) &&
        Objects.equals(this.name, dashboardExecuteFiltersLinesInner.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class DashboardExecuteFiltersLinesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DashboardExecuteFiltersLinesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DashboardExecuteFiltersLinesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DashboardExecuteFiltersLinesInner is not found in the empty JSON string", DashboardExecuteFiltersLinesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DashboardExecuteFiltersLinesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DashboardExecuteFiltersLinesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DashboardExecuteFiltersLinesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DashboardExecuteFiltersLinesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DashboardExecuteFiltersLinesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DashboardExecuteFiltersLinesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<DashboardExecuteFiltersLinesInner>() {
           @Override
           public void write(JsonWriter out, DashboardExecuteFiltersLinesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DashboardExecuteFiltersLinesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DashboardExecuteFiltersLinesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DashboardExecuteFiltersLinesInner
   * @throws IOException if the JSON string is invalid with respect to DashboardExecuteFiltersLinesInner
   */
  public static DashboardExecuteFiltersLinesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DashboardExecuteFiltersLinesInner.class);
  }

  /**
   * Convert an instance of DashboardExecuteFiltersLinesInner to an JSON string
   *
   * @return JSON string
   */
