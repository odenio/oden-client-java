...
public class Target {
  ...
  public static final String SERIALIZED_NAME_TARGET_VALUE = "target_value";
  @SerializedName(SERIALIZED_NAME_TARGET_VALUE)
  @javax.annotation.Nullable
  private Double targetValue;

  public static final String SERIALIZED_NAME_LSL = "lsl";
  @SerializedName(SERIALIZED_NAME_LSL)
  @javax.annotation.Nullable
  private Double lsl;

  public static final String SERIALIZED_NAME_USL = "usl";
  @SerializedName(SERIALIZED_NAME_USL)
  @javax.annotation.Nullable
  private Double usl;
  ...
  public Target metricGroup(@javax.annotation.Nullable MetricGroup metricGroup) {
  ...
  public void setMetricGroup(@javax.annotation.Nullable MetricGroup metricGroup) {
    this.metricGroup = metricGroup;
  }


  public Target product(@javax.annotation.Nullable Product product) {
  ...
  public Target line(@javax.annotation.Nullable Line line) {
    this.line = line;
    return this;
  }
  ...
  public Target targetValue(@javax.annotation.Nullable Double targetValue) {
  ...
  public void setTargetValue(@javax.annotation.Nullable Double targetValue) {
    this.targetValue = targetValue;
  }


  public Target lsl(@javax.annotation.Nullable Double lsl) {
    this.lsl = lsl;
    return this;
  }
  ...
  public void setLsl(@javax.annotation.Nullable Double lsl) {
    this.lsl = lsl;
  }


  public Target usl(@javax.annotation.Nullable Double usl) {
    this.usl = usl;
    return this;
  }
  ...
  public void setUsl(@javax.annotation.Nullable Double usl) {
    this.usl = usl;
  }


  public Target match(@javax.annotation.Nullable Match match) {
    this.match = match;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metricGroup, target.metricGroup) &&
        Objects.equals(this.product, target.product) &&
        Objects.equals(this.line, target.line) &&
        Objects.equals(this.targetValue, target.targetValue) &&
        Objects.equals(this.lsl, target.lsl) &&
        Objects.equals(this.usl, target.usl) &&
        Objects.equals(this.match, target.match);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metricGroup, product, line, targetValue, lsl, usl, match);
  }
  ...
  public String toString() {
    ...
    sb.append("    lsl: ").append(toIndentedString(lsl)).append("\n");
    sb.append("    usl: ").append(toIndentedString(usl)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("metric_group", "product", "line", "target_value", "lsl", "usl", "match"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Target.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Target is not found in the empty JSON string", Target.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Target.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Target` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `metric_group`
      if (jsonObj.get("metric_group") != null && !jsonObj.get("metric_group").isJsonNull()) {
        MetricGroup.validateJsonElement(jsonObj.get("metric_group"));
      }
