...
public class DashboardExecuteFiltersStatesStateCategoryAndReasonsInner {
  ...
  public DashboardExecuteFiltersStatesStateCategoryAndReasonsInner() {
  }

  public DashboardExecuteFiltersStatesStateCategoryAndReasonsInner stateCategory(@javax.annotation.Nonnull Integer stateCategory) {
  ...
  public void setStateCategory(@javax.annotation.Nonnull Integer stateCategory) {
    this.stateCategory = stateCategory;
  }


  public DashboardExecuteFiltersStatesStateCategoryAndReasonsInner stateReason(@javax.annotation.Nullable String stateReason) {
  ...
  public void setStateReason(@javax.annotation.Nullable String stateReason) {
    this.stateReason = stateReason;
  }
  ...
  public boolean equals(Object o) {
    ...
    DashboardExecuteFiltersStatesStateCategoryAndReasonsInner dashboardExecuteFiltersStatesStateCategoryAndReasonsInner = (DashboardExecuteFiltersStatesStateCategoryAndReasonsInner) o;
    return Objects.equals(this.stateCategory, dashboardExecuteFiltersStatesStateCategoryAndReasonsInner.stateCategory) &&
        Objects.equals(this.stateReason, dashboardExecuteFiltersStatesStateCategoryAndReasonsInner.stateReason);
  }

  @Override
  public int hashCode() {
    return Objects.hash(stateCategory, stateReason);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DashboardExecuteFiltersStatesStateCategoryAndReasonsInner {\n");
    sb.append("    stateCategory: ").append(toIndentedString(stateCategory)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("state_category", "state_reason"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("state_category"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DashboardExecuteFiltersStatesStateCategoryAndReasonsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DashboardExecuteFiltersStatesStateCategoryAndReasonsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DashboardExecuteFiltersStatesStateCategoryAndReasonsInner is not found in the empty JSON string", DashboardExecuteFiltersStatesStateCategoryAndReasonsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DashboardExecuteFiltersStatesStateCategoryAndReasonsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DashboardExecuteFiltersStatesStateCategoryAndReasonsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DashboardExecuteFiltersStatesStateCategoryAndReasonsInner.openapiRequiredFields) {
      ...
      if ((jsonObj.get("state_reason") != null && !jsonObj.get("state_reason").isJsonNull()) && !jsonObj.get("state_reason").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `state_reason` to be a primitive type in the JSON string but got `%s`", jsonObj.get("state_reason").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DashboardExecuteFiltersStatesStateCategoryAndReasonsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DashboardExecuteFiltersStatesStateCategoryAndReasonsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DashboardExecuteFiltersStatesStateCategoryAndReasonsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DashboardExecuteFiltersStatesStateCategoryAndReasonsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<DashboardExecuteFiltersStatesStateCategoryAndReasonsInner>() {
           @Override
           public void write(JsonWriter out, DashboardExecuteFiltersStatesStateCategoryAndReasonsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DashboardExecuteFiltersStatesStateCategoryAndReasonsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DashboardExecuteFiltersStatesStateCategoryAndReasonsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DashboardExecuteFiltersStatesStateCategoryAndReasonsInner
   * @throws IOException if the JSON string is invalid with respect to DashboardExecuteFiltersStatesStateCategoryAndReasonsInner
   */
  public static DashboardExecuteFiltersStatesStateCategoryAndReasonsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DashboardExecuteFiltersStatesStateCategoryAndReasonsInner.class);
  }

  /**
   * Convert an instance of DashboardExecuteFiltersStatesStateCategoryAndReasonsInner to an JSON string
   *
   * @return JSON string
   */
