...
public class BatchMetadata {
   ...
   */
  @javax.annotation.Nullable
  public Interval getRun() {
    return run;
  }

  public void setRun(@javax.annotation.Nullable Interval run) {
    this.run = run;
  }
   ...
   * @return the BatchMetadata instance itself
   */
  public BatchMetadata putAdditionalProperty(String key, Object value) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchMetadata>() {
           @Override
           public void write(JsonWriter out, BatchMetadata value) throws IOException {
           ...
           @Override
           public BatchMetadata read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             BatchMetadata instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of BatchMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchMetadata
   * @throws IOException if the JSON string is invalid with respect to BatchMetadata
   */
  public static BatchMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchMetadata.class);
  }

  /**
   * Convert an instance of BatchMetadata to an JSON string
   *
   * @return JSON string
   */
