...
public class SearchScrapYieldRequest {
  ...
  public SearchScrapYieldRequest() {
  }

  public SearchScrapYieldRequest data(@javax.annotation.Nullable ScrapYieldData data) {
    this.data = data;
    return this;
  }
  ...
  public SearchScrapYieldRequest interval(@javax.annotation.Nonnull Interval interval) {
  ...
  public boolean equals(Object o) {
    ...
    SearchScrapYieldRequest searchScrapYieldRequest = (SearchScrapYieldRequest) o;
    return Objects.equals(this.data, searchScrapYieldRequest.data) &&
        Objects.equals(this.interval, searchScrapYieldRequest.interval);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchScrapYieldRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchScrapYieldRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchScrapYieldRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SearchScrapYieldRequest is not found in the empty JSON string", SearchScrapYieldRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchScrapYieldRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SearchScrapYieldRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SearchScrapYieldRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchScrapYieldRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchScrapYieldRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchScrapYieldRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchScrapYieldRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchScrapYieldRequest>() {
           @Override
           public void write(JsonWriter out, SearchScrapYieldRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchScrapYieldRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchScrapYieldRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchScrapYieldRequest
   * @throws IOException if the JSON string is invalid with respect to SearchScrapYieldRequest
   */
  public static SearchScrapYieldRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchScrapYieldRequest.class);
  }

  /**
   * Convert an instance of SearchScrapYieldRequest to an JSON string
   *
   * @return JSON string
   */
