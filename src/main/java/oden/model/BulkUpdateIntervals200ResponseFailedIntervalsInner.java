...
public class BulkUpdateIntervals200ResponseFailedIntervalsInner {
  ...
  public BulkUpdateIntervals200ResponseFailedIntervalsInner() {
  }

  public BulkUpdateIntervals200ResponseFailedIntervalsInner id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public BulkUpdateIntervals200ResponseFailedIntervalsInner error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BulkUpdateIntervals200ResponseFailedIntervalsInner bulkUpdateIntervals200ResponseFailedIntervalsInner = (BulkUpdateIntervals200ResponseFailedIntervalsInner) o;
    return Objects.equals(this.id, bulkUpdateIntervals200ResponseFailedIntervalsInner.id) &&
        Objects.equals(this.error, bulkUpdateIntervals200ResponseFailedIntervalsInner.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class BulkUpdateIntervals200ResponseFailedIntervalsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BulkUpdateIntervals200ResponseFailedIntervalsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BulkUpdateIntervals200ResponseFailedIntervalsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BulkUpdateIntervals200ResponseFailedIntervalsInner is not found in the empty JSON string", BulkUpdateIntervals200ResponseFailedIntervalsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BulkUpdateIntervals200ResponseFailedIntervalsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BulkUpdateIntervals200ResponseFailedIntervalsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BulkUpdateIntervals200ResponseFailedIntervalsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BulkUpdateIntervals200ResponseFailedIntervalsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BulkUpdateIntervals200ResponseFailedIntervalsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BulkUpdateIntervals200ResponseFailedIntervalsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<BulkUpdateIntervals200ResponseFailedIntervalsInner>() {
           @Override
           public void write(JsonWriter out, BulkUpdateIntervals200ResponseFailedIntervalsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BulkUpdateIntervals200ResponseFailedIntervalsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BulkUpdateIntervals200ResponseFailedIntervalsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BulkUpdateIntervals200ResponseFailedIntervalsInner
   * @throws IOException if the JSON string is invalid with respect to BulkUpdateIntervals200ResponseFailedIntervalsInner
   */
  public static BulkUpdateIntervals200ResponseFailedIntervalsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BulkUpdateIntervals200ResponseFailedIntervalsInner.class);
  }

  /**
   * Convert an instance of BulkUpdateIntervals200ResponseFailedIntervalsInner to an JSON string
   *
   * @return JSON string
   */
