...
public class IntervalBulkDelete {
  ...
  public IntervalBulkDelete() {
  }

  public IntervalBulkDelete type(@javax.annotation.Nullable IntervalType type) {
    this.type = type;
    return this;
  }
  ...
  public void setType(@javax.annotation.Nullable IntervalType type) {
    this.type = type;
  }


  public IntervalBulkDelete line(@javax.annotation.Nullable Line line) {
    this.line = line;
    return this;
  }
  ...
  public IntervalBulkDelete startTime(@javax.annotation.Nullable OffsetDateTime startTime) {
  ...
  public IntervalBulkDelete endTime(@javax.annotation.Nullable OffsetDateTime endTime) {
  ...
  public IntervalBulkDelete hardDelete(@javax.annotation.Nullable Boolean hardDelete) {
  ...
  public void setHardDelete(@javax.annotation.Nullable Boolean hardDelete) {
    this.hardDelete = hardDelete;
  }
  ...
  public boolean equals(Object o) {
    ...
    IntervalBulkDelete intervalBulkDelete = (IntervalBulkDelete) o;
    return Objects.equals(this.type, intervalBulkDelete.type) &&
        Objects.equals(this.line, intervalBulkDelete.line) &&
        Objects.equals(this.startTime, intervalBulkDelete.startTime) &&
        Objects.equals(this.endTime, intervalBulkDelete.endTime) &&
        Objects.equals(this.hardDelete, intervalBulkDelete.hardDelete);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, line, startTime, endTime, hardDelete);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IntervalBulkDelete {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "line", "start_time", "end_time", "hard_delete"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to IntervalBulkDelete
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntervalBulkDelete.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IntervalBulkDelete is not found in the empty JSON string", IntervalBulkDelete.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IntervalBulkDelete.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `IntervalBulkDelete` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IntervalBulkDelete.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IntervalBulkDelete' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IntervalBulkDelete> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IntervalBulkDelete.class));

       return (TypeAdapter<T>) new TypeAdapter<IntervalBulkDelete>() {
           @Override
           public void write(JsonWriter out, IntervalBulkDelete value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IntervalBulkDelete read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IntervalBulkDelete given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IntervalBulkDelete
   * @throws IOException if the JSON string is invalid with respect to IntervalBulkDelete
   */
  public static IntervalBulkDelete fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IntervalBulkDelete.class);
  }

  /**
   * Convert an instance of IntervalBulkDelete to an JSON string
   *
   * @return JSON string
   */
