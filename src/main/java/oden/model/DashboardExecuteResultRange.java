...
public class DashboardExecuteResultRange {
  ...
  public DashboardExecuteResultRange() {
  }

  public DashboardExecuteResultRange start(@javax.annotation.Nullable OffsetDateTime start) {
    this.start = start;
    return this;
  }
  ...
  public DashboardExecuteResultRange end(@javax.annotation.Nullable OffsetDateTime end) {
    this.end = end;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DashboardExecuteResultRange dashboardExecuteResultRange = (DashboardExecuteResultRange) o;
    return Objects.equals(this.start, dashboardExecuteResultRange.start) &&
        Objects.equals(this.end, dashboardExecuteResultRange.end);
  }
  ...
  public String toString() {
    ...
    sb.append("class DashboardExecuteResultRange {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DashboardExecuteResultRange
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DashboardExecuteResultRange.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DashboardExecuteResultRange is not found in the empty JSON string", DashboardExecuteResultRange.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DashboardExecuteResultRange.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DashboardExecuteResultRange` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DashboardExecuteResultRange.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DashboardExecuteResultRange' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DashboardExecuteResultRange> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DashboardExecuteResultRange.class));

       return (TypeAdapter<T>) new TypeAdapter<DashboardExecuteResultRange>() {
           @Override
           public void write(JsonWriter out, DashboardExecuteResultRange value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DashboardExecuteResultRange read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DashboardExecuteResultRange given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DashboardExecuteResultRange
   * @throws IOException if the JSON string is invalid with respect to DashboardExecuteResultRange
   */
  public static DashboardExecuteResultRange fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DashboardExecuteResultRange.class);
  }

  /**
   * Convert an instance of DashboardExecuteResultRange to an JSON string
   *
   * @return JSON string
   */
