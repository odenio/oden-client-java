...
public class StateReason {
  ...
  public StateReason id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public StateReason name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StateReason stateReason = (StateReason) o;
    return Objects.equals(this.id, stateReason.id) &&
        Objects.equals(this.name, stateReason.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StateReason
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StateReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StateReason is not found in the empty JSON string", StateReason.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StateReason.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `StateReason` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StateReason.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StateReason' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StateReason> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StateReason.class));

       return (TypeAdapter<T>) new TypeAdapter<StateReason>() {
           @Override
           public void write(JsonWriter out, StateReason value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StateReason read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StateReason given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StateReason
   * @throws IOException if the JSON string is invalid with respect to StateReason
   */
  public static StateReason fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StateReason.class);
  }

  /**
   * Convert an instance of StateReason to an JSON string
   *
   * @return JSON string
   */
