...
public class Line {
  ...
  public Line id(@javax.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public Line name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public Line secondaryName(@javax.annotation.Nullable String secondaryName) {
  ...
  public Line factory(@javax.annotation.Nullable Factory factory) {
  ...
  public Line match(@javax.annotation.Nullable Match match) {
    this.match = match;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, line.id) &&
        ...
        Objects.equals(this.secondaryName, line.secondaryName) &&
        Objects.equals(this.factory, line.factory) &&
        Objects.equals(this.match, line.match);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, secondaryName, factory, match);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "name", "secondary_name", "factory", "match"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("secondary_name") != null && !jsonObj.get("secondary_name").isJsonNull()) && !jsonObj.get("secondary_name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `secondary_name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("secondary_name").toString()));
      }
