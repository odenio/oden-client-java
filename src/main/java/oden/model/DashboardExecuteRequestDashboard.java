...
public class DashboardExecuteRequestDashboard {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  @javax.annotation.Nonnull
  private UUID id;

  public DashboardExecuteRequestDashboard() {
  }

  public DashboardExecuteRequestDashboard id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DashboardExecuteRequestDashboard dashboardExecuteRequestDashboard = (DashboardExecuteRequestDashboard) o;
    return Objects.equals(this.id, dashboardExecuteRequestDashboard.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class DashboardExecuteRequestDashboard {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DashboardExecuteRequestDashboard
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DashboardExecuteRequestDashboard.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DashboardExecuteRequestDashboard is not found in the empty JSON string", DashboardExecuteRequestDashboard.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DashboardExecuteRequestDashboard.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DashboardExecuteRequestDashboard` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DashboardExecuteRequestDashboard.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DashboardExecuteRequestDashboard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DashboardExecuteRequestDashboard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DashboardExecuteRequestDashboard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DashboardExecuteRequestDashboard.class));

       return (TypeAdapter<T>) new TypeAdapter<DashboardExecuteRequestDashboard>() {
           @Override
           public void write(JsonWriter out, DashboardExecuteRequestDashboard value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DashboardExecuteRequestDashboard read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DashboardExecuteRequestDashboard given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DashboardExecuteRequestDashboard
   * @throws IOException if the JSON string is invalid with respect to DashboardExecuteRequestDashboard
   */
  public static DashboardExecuteRequestDashboard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DashboardExecuteRequestDashboard.class);
  }

  /**
   * Convert an instance of DashboardExecuteRequestDashboard to an JSON string
   *
   * @return JSON string
   */
