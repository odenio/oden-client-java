...
public class V2IntervalsSetPost200Response {
  ...
  private List<String> intervalIds = new ArrayList<>();

  public V2IntervalsSetPost200Response() {
  }

  public V2IntervalsSetPost200Response intervalIds(@javax.annotation.Nullable List<String> intervalIds) {
    this.intervalIds = intervalIds;
    return this;
  }

  public V2IntervalsSetPost200Response addIntervalIdsItem(String intervalIdsItem) {
    if (this.intervalIds == null) {
      this.intervalIds = new ArrayList<>();
    }
    this.intervalIds.add(intervalIdsItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<String> getIntervalIds() {
    return intervalIds;
  }

  public void setIntervalIds(@javax.annotation.Nullable List<String> intervalIds) {
    this.intervalIds = intervalIds;
  }
  ...
  public boolean equals(Object o) {
    ...
    V2IntervalsSetPost200Response v2IntervalsSetPost200Response = (V2IntervalsSetPost200Response) o;
    return Objects.equals(this.intervalIds, v2IntervalsSetPost200Response.intervalIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(intervalIds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V2IntervalsSetPost200Response {\n");
    sb.append("    intervalIds: ").append(toIndentedString(intervalIds)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("interval_ids"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to V2IntervalsSetPost200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V2IntervalsSetPost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V2IntervalsSetPost200Response is not found in the empty JSON string", V2IntervalsSetPost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V2IntervalsSetPost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V2IntervalsSetPost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("interval_ids") != null && !jsonObj.get("interval_ids").isJsonNull() && !jsonObj.get("interval_ids").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `interval_ids` to be an array in the JSON string but got `%s`", jsonObj.get("interval_ids").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V2IntervalsSetPost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V2IntervalsSetPost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V2IntervalsSetPost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V2IntervalsSetPost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<V2IntervalsSetPost200Response>() {
           @Override
           public void write(JsonWriter out, V2IntervalsSetPost200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V2IntervalsSetPost200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V2IntervalsSetPost200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V2IntervalsSetPost200Response
   * @throws IOException if the JSON string is invalid with respect to V2IntervalsSetPost200Response
   */
  public static V2IntervalsSetPost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V2IntervalsSetPost200Response.class);
  }

  /**
   * Convert an instance of V2IntervalsSetPost200Response to an JSON string
   *
   * @return JSON string
   */
