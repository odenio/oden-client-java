...
public class V2LineSearchPost500Response {
  ...
  public V2LineSearchPost500Response() {
  }

  public V2LineSearchPost500Response error(@javax.annotation.Nonnull String error) {
    this.error = error;
    return this;
  }
  ...
  public V2LineSearchPost500Response retryable(@javax.annotation.Nonnull Boolean retryable) {
  ...
  public V2LineSearchPost500Response id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    V2LineSearchPost500Response v2LineSearchPost500Response = (V2LineSearchPost500Response) o;
    return Objects.equals(this.error, v2LineSearchPost500Response.error) &&
        Objects.equals(this.retryable, v2LineSearchPost500Response.retryable) &&
        Objects.equals(this.id, v2LineSearchPost500Response.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(error, retryable, id);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V2LineSearchPost500Response {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("error", "retryable", "id"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("error", "retryable", "id"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V2LineSearchPost500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V2LineSearchPost500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V2LineSearchPost500Response is not found in the empty JSON string", V2LineSearchPost500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V2LineSearchPost500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V2LineSearchPost500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V2LineSearchPost500Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V2LineSearchPost500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V2LineSearchPost500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V2LineSearchPost500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V2LineSearchPost500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<V2LineSearchPost500Response>() {
           @Override
           public void write(JsonWriter out, V2LineSearchPost500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V2LineSearchPost500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V2LineSearchPost500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V2LineSearchPost500Response
   * @throws IOException if the JSON string is invalid with respect to V2LineSearchPost500Response
   */
  public static V2LineSearchPost500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V2LineSearchPost500Response.class);
  }

  /**
   * Convert an instance of V2LineSearchPost500Response to an JSON string
   *
   * @return JSON string
   */
