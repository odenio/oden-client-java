...
public class SetScrapYieldRequest {
  ...
  public SetScrapYieldRequest() {
  }

  public SetScrapYieldRequest data(@javax.annotation.Nonnull ScrapYieldData data) {
    this.data = data;
    return this;
  }
  ...
  public SetScrapYieldRequest interval(@javax.annotation.Nonnull Interval interval) {
  ...
  public boolean equals(Object o) {
    ...
    SetScrapYieldRequest setScrapYieldRequest = (SetScrapYieldRequest) o;
    return Objects.equals(this.data, setScrapYieldRequest.data) &&
        Objects.equals(this.interval, setScrapYieldRequest.interval);
  }
  ...
  public String toString() {
    ...
    sb.append("class SetScrapYieldRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetScrapYieldRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetScrapYieldRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SetScrapYieldRequest is not found in the empty JSON string", SetScrapYieldRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetScrapYieldRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SetScrapYieldRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SetScrapYieldRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetScrapYieldRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetScrapYieldRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetScrapYieldRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetScrapYieldRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SetScrapYieldRequest>() {
           @Override
           public void write(JsonWriter out, SetScrapYieldRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetScrapYieldRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetScrapYieldRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetScrapYieldRequest
   * @throws IOException if the JSON string is invalid with respect to SetScrapYieldRequest
   */
  public static SetScrapYieldRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetScrapYieldRequest.class);
  }

  /**
   * Convert an instance of SetScrapYieldRequest to an JSON string
   *
   * @return JSON string
   */
