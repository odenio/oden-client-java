...
public class RunMetadata {
  ...
  public RunMetadata target(@javax.annotation.Nullable Target target) {
    this.target = target;
    return this;
  }
   ...
   * @return the RunMetadata instance itself
   */
  public RunMetadata putAdditionalProperty(String key, Object value) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to RunMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RunMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RunMetadata is not found in the empty JSON string", RunMetadata.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RunMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RunMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RunMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RunMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<RunMetadata>() {
           @Override
           public void write(JsonWriter out, RunMetadata value) throws IOException {
           ...
           @Override
           public RunMetadata read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RunMetadata instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of RunMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RunMetadata
   * @throws IOException if the JSON string is invalid with respect to RunMetadata
   */
  public static RunMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RunMetadata.class);
  }

  /**
   * Convert an instance of RunMetadata to an JSON string
   *
   * @return JSON string
   */
