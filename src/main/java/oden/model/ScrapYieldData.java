...
import oden.model.ScrapYieldSchema;
...
public class ScrapYieldData {
  ...
  @javax.annotation.Nullable
  private ScrapYieldSchema schema;
  ...
  public ScrapYieldData() {
  }

  public ScrapYieldData rawData(@javax.annotation.Nullable String rawData) {
  ...
  public ScrapYieldData id(@javax.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public ScrapYieldData schema(@javax.annotation.Nullable ScrapYieldSchema schema) {
    this.schema = schema;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ScrapYieldSchema getSchema() {
    return schema;
  }

  public void setSchema(@javax.annotation.Nullable ScrapYieldSchema schema) {
    this.schema = schema;
  }


  public ScrapYieldData timestamp(@javax.annotation.Nullable OffsetDateTime timestamp) {
  ...
  public ScrapYieldData match(@javax.annotation.Nullable Match match) {
    this.match = match;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ScrapYieldData scrapYieldData = (ScrapYieldData) o;
    return Objects.equals(this.rawData, scrapYieldData.rawData) &&
        Objects.equals(this.id, scrapYieldData.id) &&
        Objects.equals(this.schema, scrapYieldData.schema) &&
        Objects.equals(this.timestamp, scrapYieldData.timestamp) &&
        Objects.equals(this.match, scrapYieldData.match);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(rawData, id, schema, timestamp, match);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScrapYieldData {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("raw_data", "id", "schema", "timestamp", "match"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScrapYieldData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScrapYieldData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScrapYieldData is not found in the empty JSON string", ScrapYieldData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScrapYieldData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScrapYieldData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("raw_data") != null && !jsonObj.get("raw_data").isJsonNull()) && !jsonObj.get("raw_data").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `raw_data` to be a primitive type in the JSON string but got `%s`", jsonObj.get("raw_data").toString()));
      }
      ...
      if (jsonObj.get("schema") != null && !jsonObj.get("schema").isJsonNull()) {
        ScrapYieldSchema.validateJsonElement(jsonObj.get("schema"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScrapYieldData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScrapYieldData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScrapYieldData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScrapYieldData.class));

       return (TypeAdapter<T>) new TypeAdapter<ScrapYieldData>() {
           @Override
           public void write(JsonWriter out, ScrapYieldData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScrapYieldData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScrapYieldData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScrapYieldData
   * @throws IOException if the JSON string is invalid with respect to ScrapYieldData
   */
  public static ScrapYieldData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScrapYieldData.class);
  }

  /**
   * Convert an instance of ScrapYieldData to an JSON string
   *
   * @return JSON string
   */
