...
public class BulkDeleteIntervals200Response {
  ...
  public BulkDeleteIntervals200Response() {
  }

  public BulkDeleteIntervals200Response numDeleted(@javax.annotation.Nullable Integer numDeleted) {
  ...
  public BulkDeleteIntervals200Response failedIntervals(@javax.annotation.Nullable List<String> failedIntervals) {
    this.failedIntervals = failedIntervals;
    return this;
  }

  public BulkDeleteIntervals200Response addFailedIntervalsItem(String failedIntervalsItem) {
  ...
  public boolean equals(Object o) {
    ...
    BulkDeleteIntervals200Response bulkDeleteIntervals200Response = (BulkDeleteIntervals200Response) o;
    return Objects.equals(this.numDeleted, bulkDeleteIntervals200Response.numDeleted) &&
        Objects.equals(this.failedIntervals, bulkDeleteIntervals200Response.failedIntervals);
  }
  ...
  public String toString() {
    ...
    sb.append("class BulkDeleteIntervals200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BulkDeleteIntervals200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BulkDeleteIntervals200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BulkDeleteIntervals200Response is not found in the empty JSON string", BulkDeleteIntervals200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BulkDeleteIntervals200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BulkDeleteIntervals200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BulkDeleteIntervals200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BulkDeleteIntervals200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BulkDeleteIntervals200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BulkDeleteIntervals200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<BulkDeleteIntervals200Response>() {
           @Override
           public void write(JsonWriter out, BulkDeleteIntervals200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BulkDeleteIntervals200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BulkDeleteIntervals200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BulkDeleteIntervals200Response
   * @throws IOException if the JSON string is invalid with respect to BulkDeleteIntervals200Response
   */
  public static BulkDeleteIntervals200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BulkDeleteIntervals200Response.class);
  }

  /**
   * Convert an instance of BulkDeleteIntervals200Response to an JSON string
   *
   * @return JSON string
   */
