...
public class QualitySchema {
  ...
  public QualitySchema() {
  }

  public QualitySchema id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public QualitySchema factory(@javax.annotation.Nullable Factory factory) {
  ...
  public QualitySchema schema(@javax.annotation.Nullable String schema) {
    this.schema = schema;
    return this;
  }
  ...
  public QualitySchema description(@javax.annotation.Nullable String description) {
  ...
  public QualitySchema match(@javax.annotation.Nullable Match match) {
    this.match = match;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    QualitySchema qualitySchema = (QualitySchema) o;
    return Objects.equals(this.id, qualitySchema.id) &&
        Objects.equals(this.factory, qualitySchema.factory) &&
        Objects.equals(this.schema, qualitySchema.schema) &&
        Objects.equals(this.description, qualitySchema.description) &&
        Objects.equals(this.match, qualitySchema.match);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, factory, schema, description, match);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class QualitySchema {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "factory", "schema", "description", "match"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to QualitySchema
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QualitySchema.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in QualitySchema is not found in the empty JSON string", QualitySchema.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!QualitySchema.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `QualitySchema` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QualitySchema.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QualitySchema' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QualitySchema> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QualitySchema.class));

       return (TypeAdapter<T>) new TypeAdapter<QualitySchema>() {
           @Override
           public void write(JsonWriter out, QualitySchema value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public QualitySchema read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of QualitySchema given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of QualitySchema
   * @throws IOException if the JSON string is invalid with respect to QualitySchema
   */
  public static QualitySchema fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QualitySchema.class);
  }

  /**
   * Convert an instance of QualitySchema to an JSON string
   *
   * @return JSON string
   */
