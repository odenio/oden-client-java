...
import oden.auth.Authentication;
import oden.auth.HttpBasicAuth;
import oden.auth.HttpBearerAuth;
import oden.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "https://api.oden.app";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.oden.app
     ...
     * @return a {@link oden.ApiClient} object
     */
    ...
    */
     ...
     * @throws oden.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws oden.ApiException If fail to serialize the given object
     */
     ...
     * @throws oden.ApiException If fail to read file content from response and write to disk
     ...
     * @throws oden.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws oden.ApiException If the response has an unsuccessful status code or
     ...
     * @throws oden.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws oden.ApiException If fails to update the parameters
     */
     ...
     * @throws oden.ApiException If fail to serialize the request body object into a string
     */
