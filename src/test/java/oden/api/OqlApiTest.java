...
/**
 * API tests for OqlApi
 */
@Disabled
public class OqlApiTest {

    private final OqlApi api = new OqlApi();
     ...
     */
    @Test
    public void v2OqlQueryPostTest() throws ApiException {
        OQLQuery oqLQuery = null;
        String format = null;
        api.v2OqlQueryPost(oqLQuery, format);
