...
public class DashboardsApiTest {
     ...
     */
    @Test
    public void executeDashboardTest() throws ApiException {
        DashboardExecuteRequest dashboardExecuteRequest = null;
        List<DashboardExecuteResult> response = api.executeDashboard(dashboardExecuteRequest);
